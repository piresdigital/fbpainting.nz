  ...
  return (
    <>
      <div className='relative pt-28 pb-24 mb-36 md:pb-28 bg-brand-red-500 -z-10'>
        <div className='absolute top-0 left-0 w-full h-full -z-20 text-white opacity-40 bg-[url(/images/slider/image-1.jpg)] bg-cover bg-top md:bg-center md:bg-fixed'></div>
        ...
        <h4 className='relative w-[80%] max-w-4xl mx-auto text-xl text-white pt-10'>
          {path}
        </h4>
      </div>
    </>
